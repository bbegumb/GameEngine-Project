...
void EntityController::addMaterial(Entity* entity){
    if(!entity) return;
    if(!entity->hasComponent<MaterialComponent>()){
...
void EntityController::addPointLight(Entity* entity){
    if(!entity) return;
...
void EntityController::addDirectionalLight(Entity* entity){
    if(!entity) return;
